...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"services/Service.js":[function(require,module,exports) {
"use strict";
...
var Service = /*#__PURE__*/function () {
  function Service(config) {
    ...
    this.service = _axios.default.create(_objectSpread({
...
exports.default = _default;
},{"./Service.js":"services/Service.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
console.log(_UserService.default);
...
function renderUsers(users) {
  users.map(function (user) {
    output += "\n      <div class=\"users-list\">\n      <div class=\"card mt-4 bg-ligt\">\n      <div class=\"card-body\" data-id=".concat(user.id, ">\n        <h5 class=\"last-name-value\">").concat(user.last_name, "</h5>\n        <h5 class=\"first-name-value\">").concat(user.first_name, "</h5>\n        <p class=\"email-value\">").concat(user.email, "</p>\n        <a href=\"#\" class=\"card-link\" id=\"edit-user\">Edit</a>\n        <a href=\"#\" class=\"card-link\" id=\"delete-user\">Delete</a>\n      </div>\n      </div>\n      </div>\n      ");
  });
...
usersList.addEventListener("click", function (e) {
  // e.preventDefault();
  var delBtn = e.target.id === "delete-user";
  var id = e.target.parentElement.dataset.id; //delete
...
usersList.addEventListener("click", function (e) {
  var editBtn = e.target.id === "edit-user";
  var id = e.target.parentElement.dataset.id;

  if (editBtn) {
    var parent = e.target.parentElement;
    var lastNameContent = parent.querySelector(".last-name-value").textContent;
    var firstNameContent = parent.querySelector(".first-name-value").textContent;
    var emailContent = parent.querySelector(".email-value").textContent;
  ...
  btnSubmit.addEventListener("click", function (e) {
    ...
    _axios.default.patch("http://localhost:3001/users/".concat(id), {
...
addUserForm.addEventListener("submit", /*#__PURE__*/function () {
...
},{"axios":"node_modules/axios/index.js","./services/UserService.js":"services/UserService.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
